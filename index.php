                ...
                <div class="col-md-8">
                    ...
                    ?>
                        ...
                        if(mysqli_num_rows($result1)>0){
                            ...
                            if($page > 1){
                             $prev_page = ($page - 1);   
                             echo "<li class><a href='index.php?page_no=$prev_page'>Prev</a></li>";
                            }
                            ...
                            for($i=1;$i<=$total_pages; $i++){
                                ...
                                echo "<li class='$active'><a href='index.php?page_no=$i'>$i</a></li>";
                            }

                            
                        if($total_pages > $page){
                            $next_page = ($page + 1);
                            echo "<li><a href='users.php?page_no=$next_page'>Next</a></li>";
                        }
                            echo "</ul>";
                        }
                        ?>
